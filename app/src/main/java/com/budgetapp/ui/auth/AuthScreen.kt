...
fun AuthScreen(
    ...
    if (uiState.isFirstTime) {
        SetupPasswordScreen(
            ...
            onCreatePassword = { pass, confirm -> viewModel.createPassword(pass, confirm) },
...
private fun SetupPasswordScreen(
    ...
    Column(
        ...
        Text(
            text = "Set a password to protect your financial data",
